...
type Oto2NoCTAGroupProps = {
  paymentIntentId?: string;
  priceId?: string;
};

export function Oto2NoCTAGroup({ paymentIntentId, priceId }: Oto2NoCTAGroupProps) {
  const handleYesClick = () => {
    trackCustomEvent("RS_OTO2No_Yes_Click", {
      route: "/oto2-no",
      value: 57,
      currency: "EUR",
    });
  ...
  const handleNoClick = () => {
    trackCustomEvent("RS_OTO2No_No_Click", { route: "/oto2-no" });
  };
