...
// CSS Styles (extracted from HTML)
const styles = `
  /* CSS Variables */
  :root {
...
export default function GHLTestPage() {
  ...
  return (
    <>
      ...
      <Script id="ghl-landing-script" strategy="afterInteractive">
        {`
          // ============================================
          ...
          const CONFIG = {
            ...
            wistiaVideoId: "WISTIA_VIDEO_ID_HERE"
          };
      ...
      <div className="ss-container">
        <header className="ss-section ss-header">
          <div className="ss-category-tag">LJUBAVNI ODNOSI</div>
          <h1 className="ss-headline">
            <em>On ne zna da ti se sviđa.</em> Zato ne prilazi.{" "}
            <strong className="u">ALI evo kako ćeš mu reći da priđe bez izgovorene riječi.</strong>
          </h1>
          <div className="ss-byline">
            13. studenog 2025. • <strong>SignaliStrasti tim</strong> |{" "}
            <em>Balkanska studija neverbalne privlačnosti</em>
          </div>
          <blockquote className="ss-lead-quote">
            "Prilaze mi samo oni koje ne bih ni pogledala. A onaj koji mi se sviđa – ništa."
          </blockquote>
        </header>

        <section className="ss-section ss-hero">
          <h2 className="ss-hero-title">
            <strong>Danas, čak i kad ga pogledaš — on neće prići, osim ako ne zna da smije.</strong>
          </h2>
          <p
            className="ss-sub-lead"
            style={{ fontSize: "18.5px", lineHeight: "1.9", marginBottom: "var(--ss-spacing-xl)" }}
          >
            <u>Evo što mu zapravo trebaš "reći" — bez da izgovoriš ijednu riječ.</u>
          </p>

          <div className="ss-video-wrapper">
            <div className="ss-video-container" id="ss-wistia-container"></div>
            <div className="ss-video-gate" id="ss-video-gate">
              <img
                src="https://via.placeholder.com/1280x720/1a1a1a/ffffff?text=Video+Thumbnail"
                alt="Video thumbnail"
                className="ss-video-thumbnail"
                id="ss-video-thumbnail"
              />
              <button className="ss-play-button" id="ss-play-button" aria-label="Play video">
                <svg viewBox="0 0 24 24">
                  <path d="M8 5v14l11-7z" />
                </svg>
              </button>
              <div className="ss-play-text">Klikni da otključaš video</div>
            </div>
          </div>
        </section>
        ...
        <section className="ss-section">
          ...
          <ul className="ss-checklist">
            <li className="ss-checklist-item">
              <div className="ss-checklist-icon">
                <svg viewBox="0 0 24 24">
                  <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
                </svg>
              </div>
              <div className="ss-checklist-text">
                <strong>Tri neverbalna signala</strong> koje mu pokazuju da si zainteresovana, bez
                da progovoriš
              </div>
            </li>
            <li className="ss-checklist-item">
            ...
            <li className="ss-checklist-item">
              ...
              <div className="ss-checklist-text">
                <strong>Pravi trenutak</strong> kada treba da koristiš ove signale za maksimalni
                efekat
              </div>
            </li>
          </ul>
        ...
        <section className="ss-section">
          <h2 className="ss-text-center">Šta kažu drugi:</h2>
          <div className="ss-testimonials">
            <div className="ss-testimonial">
              <p className="ss-testimonial-text">
                "Nakon što sam primenila ove signale, on je prišao već prvi put kada sam ga videla.
                Nije bilo potrebno ništa reći!"
              </p>
              <div className="ss-testimonial-author">— Ana, Beograd</div>
            </div>
            <div className="ss-testimonial">
              <p className="ss-testimonial-text">
                "Ovo je promenilo moj pristup potpuno. Sada znam kako da pokažem interesovanje bez
                da osećam nelagodu."
              </p>
              <div className="ss-testimonial-author">— Marija, Novi Sad</div>
            </div>
            <div className="ss-testimonial">
              <p className="ss-testimonial-text">
                "Radilo je od prvog dana. On je primetio signale i prišao mi prirodno, bez ikakvog
                pritiska."
              </p>
              <div className="ss-testimonial-author">— Jovana, Niš</div>
            </div>
            <div className="ss-testimonial">
              <p className="ss-testimonial-text">
                "Najbolja investicija u sebe. Ovi neverbalni signali su moćniji nego što sam
                mislila."
              </p>
              <div className="ss-testimonial-author">— Sofija, Zagreb</div>
            </div>
          </div>
        </section>

        <section className="ss-section">
          <h2 className="ss-text-center">Kompletan vodič za neverbalnu privlačnost</h2>
          <p
            className="ss-text-center"
            style={{
              fontSize: "1.1rem",
              color: "var(--ss-color-text-light)",
              marginBottom: "var(--ss-spacing-xl)",
            }}
          >
        ...
        <section className="ss-section">
          <div className="ss-cta">
            ...
            <a href="#ss-wistia-container" className="ss-cta-button">
              Pogledaj Video Sada
            </a>
          </div>
        </section>
      ...
      >
        <div className="ss-modal">
          <button className="ss-modal-close" id="ss-modal-close" aria-label="Close modal">
            <svg viewBox="0 0 24 24">
              <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" />
            </svg>
          </button>
          <h2 className="ss-modal-title" id="ss-modal-title">
            Otključaj Video
          </h2>
          <p className="ss-modal-subtitle">
            Unesi svoje podatke da otključaš video i saznaš sve o neverbalnim signalima privlačnosti.
          </p>
          <form id="ss-lead-form">
            <div className="ss-form-group">
              <label htmlFor="ss-first-name" className="ss-form-label">
                Ime *
              </label>
              <input
                type="text"
                ...
                aria-required="true"
              />
              <div className="ss-form-error" id="ss-first-name-error">
                Molimo unesite vaše ime.
              </div>
            </div>
            <div className="ss-form-group">
              <label htmlFor="ss-email" className="ss-form-label">
                Email *
              </label>
              <input
                type="email"
                ...
                aria-required="true"
              />
              <div className="ss-form-error" id="ss-email-error">
                Molimo unesite validnu email adresu.
              </div>
            </div>
            <button type="submit" className="ss-form-button" id="ss-submit-button">
